...
describe("policy parser", () => {
  ...
  let loadYaml: (input: string) => Promise<import("../../../src/types.js").Policy>;
  let loadJson: (input: string) => Promise<import("../../../src/types.js").Policy>;

  beforeAll(async () => {
    const mod = await import("../../../src/policy/parser.js");
